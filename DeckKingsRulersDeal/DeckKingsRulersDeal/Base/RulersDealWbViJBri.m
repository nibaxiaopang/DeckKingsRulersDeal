...
#import "RulersDealWbViJBri.h"

@implementation RulersDealWbViJBri {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    RulersDealWbViewJBriBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [RulersDealWbViewJBriBase enableLogging]; }

+ (instancetype)bridForWebView:(WKWebView*)webView {
    RulersDealWbViJBri* bridge = [[self alloc] init];
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[RulersDealWbViewJBriBase alloc] init];
    _base.delegate = self;
}
